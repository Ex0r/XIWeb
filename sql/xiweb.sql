...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2016 at 03:08 AM
...
CREATE TABLE `accounts_friends` (
  `accid` int(11) DEFAULT NULL COMMENT 'Account ID friend request originated from',
  `friendaccid` int(11) DEFAULT NULL COMMENT 'Account ID of Friend (Should match another reversed entry)',
  `linkedchar` varchar(50) DEFAULT NULL COMMENT 'Character name used for linking purposes',
  `status` int(11) DEFAULT NULL COMMENT 'Status of the friend request: 0=pending, 1=accepted'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table for holding friends list data';

-- --------------------------------------------------------

--
-- Table structure for table `chars_favorites`
--

CREATE TABLE `chars_favorites` (
...
--
-- Table structure for table `chars_visibility`
--

CREATE TABLE `chars_visibility` (
  `charid` int(11) NOT NULL,
  `status` int(1) NOT NULL COMMENT '0=visible, 1=hidden'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Truncate table before insert `page_permissions`
--
...
INSERT INTO `page_permissions` (`pagename`, `permission`) VALUES
('index', 'require_auth'),
('characters', 'require_auth');
...
INSERT INTO `titles` (`title`, `titleid`) VALUES
...
--
-- Indexes for table `chars_visibility`
--
ALTER TABLE `chars_visibility`
